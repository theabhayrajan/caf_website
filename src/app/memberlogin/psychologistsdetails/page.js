...
export default function OTPLoginStatic() {
    ...
    const psychologistId = params.get("psychologistId"); // 👈 GET ID FROM URL
    ...
    const handleSubmit = async (e) => {
        ...
        if (!psychologistId) {
            toast.error("Missing psychologist ID");
            return;
        }
        ...
        const res = await fetch("/api/psychologist/profile", {
            ...
            body: JSON.stringify({ 
                ...
                provides_counselling: agreeToService,
                counselling_website: website,
            })
        });
