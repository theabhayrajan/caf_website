    ...
    <section className="bg-gray-50 py-16 px-6 md:px-7 w-full">
      ...
      <div className="flex flex-wrap justify-center gap-10 lg:gap-5">
        {programs.map((program, index) => (
          <div
            key={index}
            className="bg-white shadow-sm hover:shadow-md transition-all p-10 px-14 flex flex-col items-center text-center w-full lg:w-[31.9%] max-w-[485px] gap-6
          ...
          >
            ...
            <p className="text-[#8F8F8F] text-xl sm:text-[1.4rem] md:text-[1.5rem] mb-6 lg:text-xl xl:text-2xl">
              {program.description}
            </p>
